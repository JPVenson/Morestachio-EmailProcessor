...
namespace Morestachio.MailProcessor.Ui.Behaviors.Trigger
{
	...
	public class SetFieldAction : TriggerActionBase
	{
		...
		static SetFieldAction()
		{
			FieldNameProperty = DependencyProperty.Register(
				nameof(FieldName), typeof(object), typeof(SetFieldAction),
				new FrameworkPropertyMetadata(default(object)));
			TrueValueProperty = DependencyProperty.Register(
				nameof(TrueValue), typeof(object), typeof(SetFieldAction),
				new FrameworkPropertyMetadata(default(object)));
